...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"/api/user/login","method":"post","propertyName":"token"},"logout":{"url":"/api/account/logout","method":"post"},"user":{"url":"http://localhost:8080/api/account/info","method":"get","propertyName":"id"}},"tokenRequired":true,"tokenType":"","_name":"local"}))
